...
<body>
    ...
    <div class="bg-light" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="<?= base_url('berita'); ?>" class="list-group-item list-group-item-action bg-dark active">Berita</a>
        <?php if($this->session->userdata('roles')==1):?>
        	<a href="<?= base_url('user'); ?>" class="list-group-item list-group-item-action bg-light">User</a>
          <a href="<?= base_url('kategori'); ?>" class="list-group-item list-group-item-action bg-light">Category</a>
        <?php endif?>
      </div>
    </div>
